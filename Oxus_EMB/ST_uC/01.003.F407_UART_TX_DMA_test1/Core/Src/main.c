...
/*
 * 2Mbps USART3 TX DMA non-blocking is tested with DebugPrint(); function
 * Enabling USART global interrupt is important for DMA transfer
...
/* USER CODE BEGIN 4 */
// Callback from HAL when DMA transfer completes
