...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(str[0] == 147 && str[1] == 32 && str[2] == 11 && str[3] == 179 && str[4] == 59)
	  {
		  DebugPrint("CARD\r\n");
		  memset(str,0,sizeof(str));
	  }

	  if(str[0] == 147 && str[1] == 32 && str[2] == 4 && str[3] == 185 && str[4] == 219)
	  {
		  DebugPrint("TAG\r\n");
		  memset(str,0,sizeof(str));
	  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, RFID_RC522_RST_Pin|SPI2_CS_SW_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RFID_RC522_RST_Pin SPI2_CS_SW_Pin */
  GPIO_InitStruct.Pin = RFID_RC522_RST_Pin|SPI2_CS_SW_Pin;
