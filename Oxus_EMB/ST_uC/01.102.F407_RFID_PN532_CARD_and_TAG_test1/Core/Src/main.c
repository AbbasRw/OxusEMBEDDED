...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, RFID_PN532_RST_Pin|SPI2_CS_SW_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RFID_PN532_RST_Pin SPI2_CS_SW_Pin */
  GPIO_InitStruct.Pin = RFID_PN532_RST_Pin|SPI2_CS_SW_Pin;
